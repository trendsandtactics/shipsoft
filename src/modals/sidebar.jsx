...
import Logo from "@assets/img/logo/shipsoftlogo.webp";
                ...
                <div className="offcanvas__content">
                    <div className="offcanvas__top mb-50 d-flex justify-content-between align-items-center">
                        <div className="offcanvas__logo logo">
                            <Link href="/home-2">
                            <Image src={Logo} alt="logo" style={{maxWidth: '150px', height: 'auto'}} />
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="offcanvas__social"> 
                        <a className="icon facebook" href="https://www.facebook.com/shipsoft.co"><i className="fab fa-facebook-f"></i></a>
                        <a className="icon twitter" href="https://x.com/Shipsoft_"><i className="fab fa-twitter"></i></a>
                        <a className="icon youtube" href="https://www.youtube.com/@shipsoft7931"><i className="fab fa-youtube"></i></a>
                        <a className="icon linkedin" href="https://www.linkedin.com/company/shipsoft-solutions"><i className="fab fa-linkedin"></i></a>
                    </div>
                </div>
                </div>
            </div>
