                  ...
                  <div className="col-xl-4 col-lg-6">
                     <div className="tp-cta-2-content text-center">
                        ...
                        <div className="tp-cta-2-content-inner">
                           <h3 className="cta-title"><a href="tel:+97143704077">+971 43 704077</a></h3>
                  ...
                  <div className="col-xl-6 col-lg-6">
                     <div className="tp-cta-2-title-wrapper">
                        ...
                        <h3 className="tp-section-title">
                           Searching for the Right Technology Partner for Your Business?
                        </h3>
                        <div className="tp-cta-2-btn">
                           <Link className="tp-btn" href="/contact">Get a Free Quote</Link>
                        </div>
                     </div>
                  </div>
